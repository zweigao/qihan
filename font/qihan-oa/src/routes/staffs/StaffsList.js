...
class StaffsList extends React.Component {
  ...
  render() {
    ...
    onCancel = {
      ...
      <ExtractionForm data={data[index]} ref="form" onSubmit={this.saveExtraction} loading={this.props.loading.global}/> <
      /Modal> < /
    Card >
  );
}
