...
export function getIdCardInfo(idCode) {
  return axios.post('IdentityCardInfo/getIdCardInfo.action', {
    idCode
  })
}

export function getMenuItemRegisterInfo(registerItemId) {
  return axios.get('RegisterAction/getMenuItemRegisterInfo.action', {
    params: {
      registerItemId
    }
  })
...
export function getPhoneCodeValidator(phone) {
  return axios.get('RegisterAction/getVerificationSms.action', {
    params: {
      phone
    }
  })
...
export function getPhoneCodeValidatorForModify(phone) {
  return axios.get('RegisterAction/getVerificationSmsForModify.action', {
    params: {
      phone
    }
  })
...
export function getApplymentInfo(registerId, idCode) {
  return axios.get('RegisterAction/getOriginInfo.action', {
    params: {
      registerId,
      idCode
    }
